...
import { ArrowLeft, ArrowUpRight, CheckCircle2, ChevronRight, ClipboardCheck, Plus, RefreshCw, Users } from "lucide-react";
...
export function TripDashboard({ tripId }: { tripId: string }) {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const result = await appApi<{ dashboard: TravelerDashboardRecord }>(`/api/bot/trips/${encodeURIComponent(tripId)}/dashboard`);
